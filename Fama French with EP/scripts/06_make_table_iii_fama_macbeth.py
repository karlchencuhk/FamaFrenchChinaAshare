    ...
    with open(cfg.OUTPUT_DIR / 'membership_jul_to_jun.csv', newline='', encoding='utf-8') as f:
        ...
        for row in r:
            ...
            by_month[m].append({
                ...
                'eplus_p': to_float(row['eplus_p']),
                'neg_e': to_float(row['neg_e']),
            })
    return by_month
...
def main():
    ...
    models = [
        ...
        ('M8_eplusp_nege', ['eplus_p', 'neg_e']),
        ('M9_all3_ep', ['beta', 'ln_size', 'ln_be_me', 'eplus_p', 'neg_e']),
    ]
    ...
    with open(out_table, 'w', newline='', encoding='utf-8') as f:
        ...
        for model_name, _ in models:
            for coef_name in ['intercept', 'beta', 'ln_size', 'ln_be_me', 'eplus_p', 'neg_e']:
