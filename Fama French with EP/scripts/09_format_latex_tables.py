...
def table_iii_tex():
    ...
    notes = [
        ...
        'Returns are measured as excess monthly returns. '
        '$\\ln(ME)$ is log market equity at June-end; '
        '$\\ln(BE/ME)$ is log book-to-market measured in December of the prior year.',
        '$E^{+}/P$ follows Fama (1992): $E/P$ when earnings are positive and 0 otherwise; '
        '$NEG\\_E$ is an indicator equal to 1 for negative earnings and 0 otherwise.',
    ]
    return wrap_table(
